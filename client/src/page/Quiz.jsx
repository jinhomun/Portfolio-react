...
const Quiz = () => {
    useEffect(() => {
        ...
        linkClickHandler(".item.i4", "/search");
        linkClickHandler(".item.i15", "https://github.com/jinhomun/QuizEffect", true);
        linkClickHandler(".item.i16", "https://jinhomun.github.io/webs2024/javascript/quiz/quizEffect01.html",true);
    ...
    return (
        <>
            <div id="item__wrap2" class="fixed">
                ...
                <div className="item i4 noR home" href="/search">
                    <div className="item__inner">
                ...
                <div className="item i9 black">
                    <div className="list">
                        <div className="item__inner">
                            <p className="desc">
                            객관식과 주관식의 유형의 퀴즈를 만들어보았고, JSON파일의 데이터를 출력하는 방법을 배웠습니다.<br />
...
8. Script는 링크클릭!! 👉 <a href="https://github.com/jinhomun/QuizEffect/blob/main/Quiz/quizEffect07.html"><em>GitHub Link</em></a>
                ...
                <div className="item i15 noB title" href="https://github.com/jinhomun/QuizEffect">
                ...
                <div className="item i16 noR noB title" href="https://jinhomun.github.io/webs2024/javascript/quiz/quizEffect01.html">
