...
import imgProm1 from "../assets/img/prom1.png";
import imgProm2 from "../assets/img/prom2.png";
import imgProm3 from "../assets/img/prom3.png";
...
const Promptopia = () => {
  useEffect(() => {
    ...
    linkClickHandler(
      ".item.i15",
      "https://github.com/jinhomun/Next.js-Promptopia",
      true
    );
    linkClickHandler(
      ".item.i16",
      "https://next-js-promptopia-one.vercel.app/",
      true
    );
    // ...
  }, []);
      ...
      <div id="item__wrap2" className="fixed">
        ...
        <div className="item i5 skill">
          <div className="item__inner">
            <h3>skill</h3>
            <p className="desc">
              Promptopia사이트에서 Next.js와 tailwindcss을 활용
            </p>
          </div>
          <div className="item__bg"></div>
        </div>
          ...
          <div className="item__inner">
            ...
            <div className="sliderWrap">
              <div className="slider">
                <img src={imgProm1} alt="Prom1" />
              </div>
              <div className="slider">
                <img src={imgProm2} alt="Prom2" />
              </div>
              <div className="slider">
                <img src={imgProm3} alt="Prom3" />
              </div>
            </div>
          </div>
          <div className="item__bg"></div>
        ...
        <div
          ...
          href="https://github.com/jinhomun/Next.js-Promptopia"
        >
          <div className="item__inner">
            <h3>code view</h3>
            <p className="desc">
        ...
        <div
          ...
          href="https://next-js-promptopia-one.vercel.app/"
        >
          <div className="item__inner">
            <h3>site view</h3>
